...
| ----------------- | ---- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------ | -------------- |
| **美团**          | 1    | 点击“外卖”按钮                                               | 检查点击“外卖”按钮后是否进入外卖页面                         | （No Response）No response after clicking the button                 | 1              |
|                   | 2    | 点击左上角的定位信息，修改定位改为北京市                     | 检查修改定位后主页定位是否为北京                             | （Unexpected Result）The homepage location has not changed after modification         | 1              |
|                   | 3    | 点击“外卖 ”按钮，点击“美食”分区，点击进入店铺列表第一家店铺  | 检查美食分区列表页下第一家店铺的名称和评分是否和店铺详情页的这些数据一致 | （Data Inconsistency）Inconsistent rating                       | 2              |
|                   | 4    | 在电影演出中，选择“正在热映”下的第一部电影，点击“想看”按钮   | 检查点击想看按钮后，按钮是否变灰且文本变为“已想看”           | （No Response）No response after clicking the button                 | 2              |
|                   | 5    | 搜索“门票”，点击搜索推荐中的“景点门票频道”，点击“景点”按钮，点击景点列表的第一个景点，点击查看景点的评分 | 检查迪士尼在不同页面间的评分是否一致                         | （Data Inconsistency）Inconsistent rating on the scenic spot details page             | 1              |
|                   | 6    | 点击“我的”，点击设置，新增一个收货地址，点击选择收货地址，选择屏幕下方列表中的第一个地址，然后填写门牌号01，姓名小明，手机号13800000000，最后保存地址 | 检查保存地址后收货地址的地点和姓名是否等于输入的值           | （Data Inconsistency）Inconsistent name in the shipping address             | 2              |
| **小红书**        | 7    | 点击第一条推文，点击点赞按钮                                 | 检查点击点赞按钮后按钮是否变红，点赞数是否加1                | （Unexpected Result）Like count decreased by 1                    | 2              |
|                   | 8    | 点击“我”，点击设置按钮，点击“隐私设置”，点击“在线状态”，将其修改为“公开” | 检查修改为“公开”后的在线状态是否变为公开                     | （No Response）The online status did not change after checking         | 1              |
| **豆瓣**          | 9    | 点击“书影音”标签，点击豆瓣榜单，点击近期热门电影Top20榜单，点击榜单第一部电影的“想看” | 检查点击想看按钮后其是否变为“已想看”                         | （No Response）No response after clicking the want to see button             | 1              |
|                   | 10   | 点击第一条推文的评论按钮                                     | 检查第一条推文的评论数在点击前后是否一致                     | （Data Inconsistency）Inconsistent number of comments before and after clicking             | 1              |
