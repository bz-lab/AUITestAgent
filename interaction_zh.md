...
我们的交互实验结果参见[这里](evaluation_results/evaluation_zh.md)。

## 任务难度分级

我们综合考量两个因素，为任务划分难度级别：理想的交互步骤数 $𝑆𝑡𝑒𝑝_{𝑖𝑑𝑒𝑎𝑙}$ 和任务描述的模糊性（即，模糊度指标 $𝑆𝑐𝑜𝑟𝑒_{vag}$， 定义为理想交互步骤数量 $𝑆𝑡𝑒𝑝_{𝑖𝑑𝑒𝑎𝑙}$ 除以任务描述中的交互命令数量）。
...
| **App**           |      | **任务描述**                                                 | **$Step_{ideal}$** | **$Score_{vag}$**  | **$Score$** | **难度** |
| ----------------- | ---- | ------------------------------------------------------------ | -------- | ------------- | --------- | -------- |
